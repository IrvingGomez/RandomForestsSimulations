...
test_comp_y_hat <- readRDS(paste0(ruta_lectura,"test_yy_COMP.rds"))
test_MCAR_5_y_hat <- readRDS(paste0(ruta_lectura,"test_yy_MCAR_5.rds"))
test_MCAR_10_y_hat <- readRDS(paste0(ruta_lectura,"test_yy_MCAR_10.rds"))
test_MCAR_20_y_hat <- readRDS(paste0(ruta_lectura,"test_yy_MCAR_20.rds"))
test_MCAR_40_y_hat <- readRDS(paste0(ruta_lectura,"test_yy_MCAR_40.rds"))
test_MCAR_60_y_hat <- readRDS(paste0(ruta_lectura,"test_yy_MCAR_60.rds"))
test_MCAR_80_y_hat <- readRDS(paste0(ruta_lectura,"test_yy_MCAR_80.rds"))
test_MCAR_90_y_hat <- readRDS(paste0(ruta_lectura,"test_yy_MCAR_90.rds"))
test_MCAR_95_y_hat <- readRDS(paste0(ruta_lectura,"test_yy_MCAR_95.rds"))

# We read the real y_values
test_comp <- readRDS(paste0(ruta_lectura_2,"COMP/test_COMP.rds"))
test_MCAR_5 <- readRDS(paste0(ruta_lectura_2,"MCAR/test_MCAR_X4_5_.rds"))
test_MCAR_10 <- readRDS(paste0(ruta_lectura_2,"MCAR/test_MCAR_X4_10_.rds"))
test_MCAR_20 <- readRDS(paste0(ruta_lectura_2,"MCAR/test_MCAR_X4_20_.rds"))
test_MCAR_40 <- readRDS(paste0(ruta_lectura_2,"MCAR/test_MCAR_X4_40_.rds"))
test_MCAR_60 <- readRDS(paste0(ruta_lectura_2,"MCAR/test_MCAR_X4_60_.rds"))
test_MCAR_80 <- readRDS(paste0(ruta_lectura_2,"MCAR/test_MCAR_X4_80_.rds"))
test_MCAR_90 <- readRDS(paste0(ruta_lectura_2,"MCAR/test_MCAR_X4_90_.rds"))
test_MCAR_95 <- readRDS(paste0(ruta_lectura_2,"MCAR/test_MCAR_X4_95_.rds"))
